    ...
    public class BookInfoModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (bookInfo.InventoryNum.Length == 0 || bookInfo.Title.Length == 0 || bookInfo.Author.Length == 0 ||
                ...
                bookInfo.Inventory.Length == 0 || bookInfo.Category.Length == 0)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        bookInfo.Year = OftenUsedMethods.CorrectIntInput(bookInfo.Year).ToString();
                        price = OftenUsedMethods.CorrectDoubleInput(bookInfo.Price);
                        ...
                        try
                        {
                            ...
                            using (SqlConnection connection = new SqlConnection(connectionString))
                            {
                                ...
                                using (SqlCommand command1 = new SqlCommand(sql, connection))
                                {
                                    ...
                                    command1.Parameters.AddWithValue("@idLibrary", LoginLibraryModel.libraryInfo.Id);
                                ...
                                if (bookInfo.InventoryNum == _inventoryNum)
                                {
                                    ...
                                    using (SqlCommand command2 = new SqlCommand(query, connection))
                                    {
                                        ...
                                        command2.Parameters.AddWithValue("@year", bookInfo.Year);
