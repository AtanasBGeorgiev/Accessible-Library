        ...
        public void OnPost()
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    int existRow;
                    string query1 = $"SELECT count(*) from [dbo].[Book] where IDReader={LoginReaderModel.readerInfo.Id}";
                    ...
                    {
                        string query2 = $"DELETE FROM [dbo].[Reader] where ID={LoginReaderModel.readerInfo.Id}";
