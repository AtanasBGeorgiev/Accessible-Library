    ...
    public class AddBookModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (bookInfo.InventoryNum.Trim().Length == 0 || bookInfo.Title.Length == 0 || bookInfo.Author.Length == 0 ||
                bookInfo.Year.Length == 0 || bookInfo.Price.Length == 0 || bookInfo.Signature.Trim().Length == 0 || bookInfo.Category.Length == 0) 
            {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        if (exist == false)
                        {
                            ...
                            using (SqlCommand command2 = new SqlCommand(query, connection))
                            {
                                ...
                                command2.Parameters.AddWithValue("@idLibrary", LoginLibraryModel.libraryInfo.Id);
