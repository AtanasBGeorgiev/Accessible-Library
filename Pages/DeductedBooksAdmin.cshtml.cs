...
{
    public class DeductedBooksAdminModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = $"SELECT InventoryNum,Title,Author,Year,Price,Signature,Inventory,Deduction,DateOfCreation FROM [dbo].[Book] where IDLibrary={AdminLibraryInfoModel.libraryInfo.Id} and Deduction!='0';";
